...
function buildPlot(stock) {
  var apiKey = "XgLJ9NxRYvx6RgEPpkjZ";
  ...
  d3.json(url).then(function(data) {
    ...
    var openingPrices = unpack(data.dataset.data, 2);
    var highPrices = unpack(data.dataset.data, 3);
    var lowPrices = unpack(data.dataset.data, 4);
